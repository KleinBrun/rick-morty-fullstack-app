...
import { AddCommentUseCase } from '../../application/addComment.js';
import { GetCharacterByIdUseCase } from '../../application/getCharacterById.js';
import { GetCharacterCommentsUseCase } from '../../application/getCharacterComments.js';
import { GetFavoriteCharacterIdsUseCase } from '../../application/getFavoriteCharacterIds.js';
import { RestoreCharacterUseCase } from '../../application/restoreCharacter.js';
import { SearchCharactersUseCase, SearchDeletedCharactersUseCase } from '../../application/searchCharacters.js';
import { SoftDeleteCharacterUseCase } from '../../application/softDeleteCharacter.js';
import { SoftDeleteCommentUseCase } from '../../application/softDeleteComment.js';
import { ToggleFavoriteUseCase } from '../../application/toggleFavorite.js';
import { redisCache } from '../../infrastructure/cache/redisClient.js';
import { startCharacterSyncCron } from '../../infrastructure/services/characterSyncCron.js';
import { CharacterModel, CommentModel, FavoriteModel, initDatabase } from '../../infrastructure/db/sequelize.js';
...
import { CharacterRepository } from '../../infrastructure/repositories/characterRepository.js';
...
import { publicCharacterSource } from '../../infrastructure/services/characterBootstrapService.js';
