...
describe('CharactersFeature integrations', () => {
    ...
    it('shows and applies the animal species filter', async () => {
        ...
        const animalFilterMocks: MockedResponse[] = [
            ...createCharactersMocks(),
            {
                request: {
                    query: GET_CHARACTER_PANEL_DATA,
                    variables: { id: '9' },
        ...
        render(
            <MockedProvider mocks={animalFilterMocks}>
                <MemoryRouter>
                    <CharactersFeature onSelectCharacter={vi.fn()} />
                </MemoryRouter>
            </MockedProvider>,
        ...
        await waitFor(() => {
            expect(screen.getAllByText('Snowball').length).toBeGreaterThan(0);
        });
    });
